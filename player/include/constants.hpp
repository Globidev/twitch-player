...
namespace constants {
    ...
    namespace settings {
        ...
        namespace shortcuts {
            ...
            Shortcut ADD_PANE_LEFT         { "Add Pane left",         "Ctrl+Left",            "shortcuts/add_pane_left" };
            Shortcut ADD_PANE_RIGHT        { "Add Pane right",        "Ctrl+Right",           "shortcuts/add_pane_right" };
            Shortcut ADD_PANE_UP           { "Add Pane up",           "Ctrl+Up",              "shortcuts/add_pane_up" };
            Shortcut ADD_PANE_DOWN         { "Add Pane down",         "Ctrl+Down",            "shortcuts/add_pane_down" };
            ...
            Shortcut TOGGLE_CHAT_LEFT      { "Toggle Chat Left",      "Ctrl+Alt+Left",        "shortcuts/toggle_chat_left" };
            Shortcut TOGGLE_CHAT_RIGHT     { "Toggle Chat Right",     "Ctrl+Alt+Right",       "shortcuts/toggle_chat_right" };
